# -*- coding: utf-8 -*-
# Autogenerated by Sphinx on Tue Dec  7 23:14:31 2021
topics = {'assert': 'The "assert" statement\n'
 ...
 'attribute-access': 'Customizing attribute access\n'
                     ...
                     '   "obj.__class__.__mro__" for a base class "B" '
                     'following "A" and then\n'
 ...
 'specialnames': 'Special method names\n'
                 ...
                 'Super Binding\n'
                 '   A dotted lookup such as "super(A, a).x" searches\n'
                 '   "obj.__class__.__mro__" for a base class "B" following '
                 '"A" and then\n'
                 '   returns "B.__dict__[\'x\'].__get__(a, A)".  If not a '
                 'descriptor, "x"\n'
                 '   is returned unchanged.\n'
